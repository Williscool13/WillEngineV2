...
enum class EngineSettingsTypeFlag : uint32_t
{
    ...
    AMBIENT_OCCLUSION_SETTINGS = 1 << 4,
    SCREEN_SPACE_SHADOWS_SETTINGS = 1 << 5,
    CASCADED_SHADOW_MAP_SETTINGS = 1 << 6,
    TEMPORAL_ANTIALIASING_SETTINGS = 1 << 7,
    POSTPROCESS_SETTINGS = 1 << 8,
    ALL = 0xFFFFFFFF
};
