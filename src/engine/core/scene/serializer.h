...
enum class EngineSettingsTypeFlag : uint32_t
{
    ...
    CAMERA_SETTINGS = 1 << 2,
    LIGHT_SETTINGS = 1 << 3,
    ENVIRONMENT_SETTINGS = 1 << 4,
    RENDERER_SETTINGS = 1 << 5,
    AMBIENT_OCCLUSION_SETTINGS = 1 << 6,
    SCREEN_SPACE_SHADOWS_SETTINGS = 1 << 7,
    CASCADED_SHADOW_MAP_SETTINGS = 1 << 8,
    TEMPORAL_ANTIALIASING_SETTINGS = 1 << 9,
    POSTPROCESS_SETTINGS = 1 << 10,
